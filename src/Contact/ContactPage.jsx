    ...
    >
      <div className="mx-auto">
        ...
        <div className="flex justify-between items-center md:items-end gap-6 w-full">
          ...
          <div className="w-16 h-16 rounded-full overflow-hidden flex-shrink-0 mt-2">
            <img
        ...
        <div className="flex flex-col md:flex-row md:justify-between gap-12 md:gap-10 mt-16 items-start">
          ...
          <div className="flex-1 min-w-0 max-w-xl md:pt-24">
            ...
            <div
              className="border-t mb-6 max-w-md"
              style={{ borderColor: "#E3D9CF" }}
            />
          ...
          {/* Right: Form card */}
          <div className="flex-1 bg-white rounded-3xl p-6 md:p-10 w-full max-w-2xl">
            ...
            <button
              className="w-full text-white rounded-xl py-4 text-sm font-bold tracking-wider transition-opacity hover:opacity-90"
